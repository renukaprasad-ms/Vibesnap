...
const ImageSec = () => {
  return (
    <div className="w-full h-full flex flex-wrap gap-2 items-center justify-evenly   overflow-hidden">
        <div className="w-[31%] h-[32%]">
          <img
